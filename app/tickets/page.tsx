...
async function TicketsPage() {
  return (
    <div className="flex-1 flex flex-col gap-y-8">
      ...
      <CardCompact title="Create ticket" description="A new ticket will be created" content={<TicketCreateForm />} className="w-full max-w-[420px] justify-center self-center" />
